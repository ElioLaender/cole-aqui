...
<head>
    ...
    <link href="view/assets/assets-dash/vendors/bootgrid/jquery.bootgrid.min.css" rel="stylesheet">
...
<section id="main">
    <aside id="sidebar" class="sidebar c-overflow">
        ...
        <ul class="main-menu">
            ...
            <li class="sub-menu active toggled">
                ...
                <ul>
                    <li><a class="active" href="?controller=Dashboard&action=viewAllClient"><i class="zmdi zmdi-assignment"></i> Listar Clientes</a></li>
    ...
    <aside id="chat" class="sidebar c-overflow">
        ...
        <div class="listview">
            <a class="lv-item" href="view/assets/assets-dash/">
                <div class="media">
        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header">
                    <h2>Lista de Clientes<small>Faça uma busca pelo cliente</small></h2>
                </div>
                ...
                <table id="data-table-command" class="table table-striped table-vmiddle">
                    ...
                    <tr>
                        ...
                        <th data-column-id="Pontuação" data-order="desc">Pontuação</th>
                        <th data-column-id="valor-gasto">Valor Gasto</th>
                        <th data-column-id="data-cadastro">Data de Cadastro</th>
                        <th data-column-id="commands" data-formatter="commands" data-sortable="false">Gerenciar</th>
                    </tr>
                    </thead>
                    <tbody id="fu">
...
<div class="ie-warning">
    ...
    <div class="iew-container">
        <ul class="iew-download">
            <li>
                <a href="view/assets/assets-dash/http://www.google.com/chrome/">
                    <img src="view/assets/assets-dash/img/browsers/chrome.png" alt="">
                    <div>Chrome</div>
                </a>
            </li>
            <li>
                <a href="view/assets/assets-dash/https://www.mozilla.org/en-US/firefox/new/">
                    <img src="view/assets/assets-dash/img/browsers/firefox.png" alt="">
                    <div>Firefox</div>
                </a>
            </li>
            <li>
                <a href="view/assets/assets-dash/http://www.opera.com">
                    <img src="view/assets/assets-dash/img/browsers/opera.png" alt="">
                    <div>Opera</div>
                </a>
            </li>
            <li>
                <a href="view/assets/assets-dash/https://www.apple.com/safari/">
                    <img src="view/assets/assets-dash/img/browsers/safari.png" alt="">
                    <div>Safari</div>
                </a>
            </li>
            <li>
                <a href="view/assets/assets-dash/http://windows.microsoft.com/en-us/internet-explorer/download-ie">
...
<script src="view/assets/assets-dash/vendors/bootgrid/jquery.bootgrid.updated.min.js"></script>
...
<script src="view/assets/js/rowAllClient.js"></script>
        ...
        $("#data-table-command").bootgrid({
            ...
            formatters: {
                "commands": function(column, row) {
                    return "<a href='?controller=Dashboard&action=viewCostumerPage&client="+ row.id +"' class=\"btn btn-icon command-edit waves-effect waves-circle\" data-row-id=\"" + row.id + "\"><span class=\"zmdi zmdi-edit\"></span></a> ";
                }
            }
