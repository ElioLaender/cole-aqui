        ...
        <ul class="main-menu">
            ...
            <li class="sub-menu active toggled">
                ...
                <ul>
                    ...
                    <li><a  class="active" href="?controller=Dashboard&action=viewNewClient"><i class="zmdi zmdi-account-add"></i> Novo Cliente</a></li>
                </ul>
            </li>
            <li class="sub-menu">
            ...
            <li><a href="?controller=Dashboard&action=viewPointManager"><i class="zmdi zmdi-mticket-star"></i> Gerenciar Pontuação</a></li>
        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header">
                    <h2>Novo Cliente<small>Adicione novos clientes para garantir sua fidelidade!</small></h2>
                    <!-- -->
                    <form method="post" action="?controller=Dashboard&action=newCient"  enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="input-group">
                                        ...
                                        <div class="fg-line">
                                            <input type="text" name="nameCli" class="form-control" value="" placeholder="Nome">
                                        </div>
                                    </div>
                                    <br/>
                                    <div class="input-group">
                                        ...
                                        <div class="fg-line">
                                            <input type="text" name="phoCli" class="form-control input-mask" data-mask="(00) 00000-0000" placeholder="Tel: (00) 00000-0000">
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="fg-line">
                                            <input type="text" name="emailCli" class="form-control" value="" placeholder="Email">
                                        </div>
                                    </div>
                                    <br/>
                                    <div class="input-group">
                                        ...
                                        <div class="fg-line">
                                            <input type="text"  class="form-control input-mask" data-mask="000.000.000-00" placeholder="CPF: 000.000.000-00" name="cpfCli" class="form-control" >
                                        </div>
                                    </div>
                                    <br/>
                                    <div class="card-body card-padding">
                                        ...
                                        <div class="radio m-b-15">
                                            <label>
                                                <input type="radio" name="sexCli" value="M" checked>
                                        ...
                                        <div class="radio m-b-15">
                                            <label>
                                                <input type="radio" name="sexCli" value="F">
                                                <i class="input-helper"></i>
                                              Feminino
                                            </label>
                                        </div>
                                    ...
                                    <br/>
                                    <br/><br/>
                                    <button type="submit" class="btn btn-primary btn-lg waves-effect">Adicionar</button>
