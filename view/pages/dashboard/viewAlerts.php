        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header">
                    <h2>Controle de notificações <small>Esta é uma lista de clientes com pontuação suficiente para trocar pontos</small></h2>
                </div>
...
<script src="view/assets/js/rowNotification.js"></script>
