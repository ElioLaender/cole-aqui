    ...
    <aside id="sidebar" class="sidebar c-overflow">
        ...
        <ul class="main-menu">
            ...
            <li class="sub-menu active toggled">
                ...
                <ul>
                    <li><a  class="active" href="?controller=Dashboard&action=viewAwardsList"><i class="zmdi zmdi-check-all"></i> Listar prêmios</a></li>
...
<script src="view/assets/js/listAwardsDash.js"></script>
