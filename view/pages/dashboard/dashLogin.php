...
<div class="lc-block" id="l-forget-password">
    <p class="text-left">Informe seu email de registro. Dentro de poucos minutos você receberá um email com a redefinição de sua senha. Caso não possua mais o email de login, entre em contato com o suporte pelo email suporte@coleaqui.com.br</p>
