        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header">
                    <h2>Taxa de conversão da sua pontuação<small>Visualize o valor especifico da pontuçao.</small></h2>
                    <h3>Valor da pontuação: R$ <span class="point-value">1,00</span><h3>
                            <small>A cada R$ <span class="point-value">1,00</span> reais vendidos, o cliente receberá 1(um) ponto.<br/> Exemplo: R$ <span id="calcExValue">1,00</span> equivale a <span id="points"></span> Pontos.<small>
                    <!-- -->
            ...
            <div class="card">
                <div class="card-header">
                    <h2>Editar Pontuação<small>Defina aqui a taxa de conversão da sua pontuação.</small></h2>

                    <form method="post" action="?controller=Dashboard&action=updatePointsValue"  enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        ...
                                        <div class="fg-line">
                                            <input type="number" name="value" class="form-control" value="" placeholder="Insira o valor necessário para adquirir os pontos, Ex: R$ 5.00">
                                        </div>
                                    </div>
                                    <br/>
                                    <button type="submit" class="btn btn-primary btn-lg waves-effect" style="margin-left: 70%">Salvar Alteração</button>
                    </form>
                </div>
            </div>
    </section>
